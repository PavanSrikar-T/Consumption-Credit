...
export const Onboarding = () => {
  ...
  const [status, setStatus] = useState<'IDLE' | 'KYC_PROOF' | 'SCANNING' | 'SELECT_LENDER' | 'FINALIZING' | 'APPROVED' | 'REJECTED'>('IDLE');
  ...
  const handleApplyOffers = () => {
    ...
    setTimeout(() => {
      ...
      import('../api/mockData').then(({ initializeCreditLines }) => {
                  ...
                  >
                    ...
                    <svg className="absolute inset-0 w-full h-full transform -rotate-90 pointer-events-none">
                      <circle
                        ...
                        strokeDashoffset={2 * Math.PI * 58 * (1 - fingerprintProgress / 100)}
